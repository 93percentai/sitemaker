...
> [!tip] Script Safety
> Since sitemaker generates static sites from your own content, raw HTML and scripts are safe. The site author controls all the content, not an untrusted user.
